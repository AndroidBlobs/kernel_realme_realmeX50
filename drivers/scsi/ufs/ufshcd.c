...
#ifndef VENDOR_EDIT
//yh@BSP.Storage.UFS, 2020-1-2 add for merge CR2514838(full CR)
...
#ifdef VENDOR_EDIT
	trace_oppo_ufs("unblock scsi_block_req_cnt",atomic_read(&hba->scsi_block_reqs_cnt));
#endif
}
...
#ifdef VENDOR_EDIT
	trace_oppo_ufs("block scsi_block_req_cnt",atomic_read(&hba->scsi_block_reqs_cnt));
#endif
}
...
static int ufshcd_clock_scaling_prepare(struct ufs_hba *hba)
{
	...
	down_write(&hba->lock);
#ifdef VENDOR_EDIT
	trace_ufs_scsi_block_rq("ufshcd_clock_scaling_prepare ufshcd_scsi_block_requests\n");
#endif
	...
	if (ufshcd_wait_for_doorbell_clr(hba, DOORBELL_CLR_TOUT_US)) {
		...
		up_write(&hba->lock);
#ifdef VENDOR_EDIT
		trace_ufs_scsi_block_rq("ufshcd_clock_scaling_prepare ufshcd_scsi_unblock_requests\n");
#endif
...
static void ufshcd_clock_scaling_unprepare(struct ufs_hba *hba)
{
	up_write(&hba->lock);
#ifdef VENDOR_EDIT
	trace_ufs_scsi_block_rq("ufshcd_clock_scaling_unprepare ufshcd_scsi_unblock_requests\n");
#endif
	ufshcd_scsi_unblock_requests(hba);
}
...
#ifdef VENDOR_EDIT
	trace_ufs_scsi_block_rq("ufshcd_devfreq_scale ufshcd_clock_scaling_prepare\n");
#endif
...
#ifdef VENDOR_EDIT
	trace_ufs_scsi_block_rq("ufshcd_devfreq_scale ufshcd_clock_scaling_unprepare\n");
#endif
...
unblock_reqs:
#ifdef VENDOR_EDIT
	trace_ufs_scsi_block_rq("ufshcd_ungate_work ufshcd_scsi_unblock_requests\n");
#endif
	ufshcd_scsi_unblock_requests(hba);
}
...
start:
	...
	case CLKS_OFF:
#ifdef VENDOR_EDIT
		trace_ufs_scsi_block_rq("ufshcd_hold ufshcd_scsi_block_requests\n");
#endif
		ufshcd_scsi_block_requests(hba);
...
#ifdef VENDOR_EDIT
		trace_ufs_scsi_block_rq("ufshcd_hibern8_hold ufshcd_scsi_block_requests\n");
#endif
		ufshcd_scsi_block_requests(hba);
...
unblock_reqs:
#ifdef VENDOR_EDIT
	trace_ufs_scsi_block_rq("ufshcd_hibern8_exit_work ufshcd_scsi_unblock_requests\n");
#endif
	ufshcd_scsi_unblock_requests(hba);
}
...
static void ufshcd_exception_event_handler(struct work_struct *work)
{
	...
	pm_runtime_get_sync(hba->dev);
#ifdef VENDOR_EDIT
	trace_ufs_scsi_block_rq("ufshcd_exception_event_handler ufshcd_scsi_block_requests\n");
#endif
	ufshcd_scsi_block_requests(hba);
...
out:
#ifdef VENDOR_EDIT
	trace_ufs_scsi_block_rq("ufshcd_exception_event_handler ufshcd_scsi_unblock_requests\n");
#endif
	ufshcd_scsi_unblock_requests(hba);
	/*
...
//yh@BSP.Storage.UFS, 2020-1-7 add for fix dead lock between ufshcd_rls_handler/ufshcd_link_recovery
	...
	ufshcd_scsi_block_requests(hba);
#ifdef VENDOR_EDIT
	trace_ufs_scsi_block_rq("ufshcd_rls_handler ufshcd_scsi_block_requests\n");
#endif
...
out:
	up_write(&hba->lock);
#ifdef VENDOR_EDIT
	trace_ufs_scsi_block_rq("ufshcd_rls_handler ufshcd_scsi_unblock_requests\n");
#endif
	ufshcd_scsi_unblock_requests(hba);
	pm_runtime_put_sync(hba->dev);
}
...
#ifdef VENDOR_EDIT
	trace_ufs_scsi_block_rq("ufshcd_shutdown ufshcd_scsi_block_requests\n");
#endif
	ufshcd_scsi_block_requests(hba);
	ret = ufshcd_wait_for_doorbell_clr(hba, U64_MAX);
	if (ret)
...
#ifdef VENDOR_EDIT
	trace_ufs_scsi_block_rq("ufshcd_shutdown ufshcd_scsi_unblock_requests\n");
#endif
	ufshcd_scsi_unblock_requests(hba);
	ufshcd_release_all(hba);
...
#ifndef VENDOR_EDIT
//yh@BSP.Storage.UFS, 2020-03-03 add for fix dead wait between ufshcd_rls_handler/ufshcd_ungate_work
